...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('message','Programare creata la data '. $request->date);  
    }
    ...
    public function check(Request $request){
        ...
        if(!$appointment){
            return redirect()->to('/appointment')->with('errmessage', 'Orele de programare nu sunt disponibile pentru aceasta data!');
        }
    ...
    public function updateTime(Request $request){
        ...
        return redirect()->route('appointment.index')->with('message', 'Orele de programare au fost actualizate!');
    }
}
