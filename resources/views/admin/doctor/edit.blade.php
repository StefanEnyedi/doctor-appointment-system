    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>Doctor</h5>
                    <span>Actualizare personal medical</span>
                </div>
            </div>
        </div>
    <div class="col-lg-4">
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        @endif
        <div class="card">
            <div class="card-header" style="background-color: #CFE2FF;"><h3 style="font-weight: 700; color: #0D6EFD;">Actualizeaza personal medical</h3></div>
            <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" id="exampleTextarea1" row="4" name="description"> {{$user->description}}</textarea>
                @error('description')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
