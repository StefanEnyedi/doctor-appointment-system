    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>Department</h5>
                    <span>Actualizeaza departamentul</span>
                </div>
            </div>
        </div>
    <div class="col-lg-4">
...
<div class="row justify-content-center">
	...
	<div class="card">
	<div class="card-header"><h3>Modificare departament</h3></div>
	<div class="card-body">
		<form class="forms-sample" action="{{route('department.update',[$department->id])}}" method="post" >@csrf
            ...
            <div class="form-group">
              ...
              <button type="submit" class="btn btn-primary mr-2">Actualizeaza</button>
            </div>
        </div>
